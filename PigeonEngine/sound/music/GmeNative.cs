...
namespace GameMusicEmuSharp
{
	...
	public static class GmeNative
	{
		...
		// TODO: documentation
		public static void MuteVoice(IntPtr emuHandle, int voiceIndex, int mute) {
			gme_mute_voice(emuHandle, voiceIndex, mute);
		}

		// TODO: documentation
		public static void MuteVoices(IntPtr emuHandle, int mutingMask) {
			gme_mute_voices(emuHandle, mutingMask);
		}

		// TODO: documentation
		public static void SetStereoDepth(IntPtr emuHandle, double depth) {
			gme_set_stereo_depth(emuHandle, depth);
		}

		// TODO: documentation
		public static void SetFade(IntPtr emuHandle, int startMSec) {
			gme_set_fade(emuHandle, startMSec);
		}

		// TODO: documentation
		public static void SetTempo(IntPtr emuHandle, double tempo) {
			gme_set_tempo(emuHandle, tempo);
		}
		#endregion
		...
		// TODO: documentation
		[DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
		public static extern void gme_mute_voice(IntPtr emuHandle, int index, int mute);
